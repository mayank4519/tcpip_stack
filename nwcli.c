...

    {
...

	 {
                 ...
                 }
		 {
                    ...
                    static param_t rt;
                    init_param(&rt, CMD, "rt", show_rt_handler, 0, INVALID, 0, "Dump Routing table");
      ...
      libcli_register_display_callback(&node, display_graph_nodes);
      {
        ...
        }
        {
            ...
            libcli_register_param(&node_name, &route);
            {
                ...
                init_param(&ip_address, LEAF, 0, 0, 0, IPV4, "ip-address", "IPV4 Address");
                libcli_register_param(&route, &ip_address);
                {
                    ...
                    libcli_register_param(&ip_address, &mask);

...
build_first_topo() {
  ...
  node_set_intf_ip_address(R0_re, "eth0/4", "40.0.0.1", 24); 
  node_set_intf_ip_address(R0_re, "eth0/0", "20.0.0.1", 24); 

  node_set_loopback_address(R2_re, "122.1.1.2");
  node_set_intf_ip_address(R2_re, "eth0/3", "30.0.0.2", 24); 
  node_set_intf_ip_address(R2_re, "eth0/5", "40.0.0.2", 24); 
  
  node_set_loopback_address(R1_re, "122.1.1.1");
  node_set_intf_ip_address(R1_re, "eth0/1", "20.0.0.2", 24); 
  node_set_intf_ip_address(R1_re, "eth0/2", "30.0.0.1", 24); 
